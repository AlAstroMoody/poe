...
type AlternateTreeVersion struct {
	Index                                  uint32 `json:"_key"`
	ID                                     string `json:"Id"`
	AreSmallAttributePassiveSkillsReplaced bool   `json:"Flag0"`
...
type AlternatePassiveSkill struct {
	...
	Stat3Min                 int32              `json:"Unknown0"`
	Stat3Max                 int32              `json:"Unknown1"`
	Stat4Min                 int32              `json:"Unknown2"`
	Stat4Max                 int32              `json:"Unknown3"`
	SpawnWeight              uint32             `json:"SpawnWeight"`
	ConquerorIndex           uint32             `json:"Unknown8"`
	RandomMin                uint32             `json:"RandomMin"`
	RandomMax                uint32             `json:"RandomMax"`
	ConquerorVersion         uint32             `json:"Unknown9"`
}
...
type AlternatePassiveAddition struct {
	...
	Stat1Min                 int32              `json:"Stat1Min"`
	Stat1Max                 int32              `json:"Stat1Max"`
	Stat2Min                 int32              `json:"Unknown0"`
	Stat2Max                 int32              `json:"Unknown1"`
	PassiveType              []PassiveSkillType `json:"PassiveType"`
}
